...
@{
    ...
    Description          = 'Client for the ZX-Next-Unite NextSync HTTP bridge: list the connected ZX Spectrum Nexts and drive their SD cards (ls/get/put/crc/ren/rcpy/...) from PowerShell 5.1+ or 7+.'
