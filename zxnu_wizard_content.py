...
TEXTS = {
    ...
    "ns.remote2": {
        "en": "From there you exchange files and whole directories "
              ...
              "back to the PC. Done for the day? Press BREAK (Caps "
              "Shift + Space) on the Next to exit the dot gracefully — "
              "an in-progress transfer always finishes first.",
        "es": "A partir de ahí intercambias archivos y carpetas "
              ...
              "al PC. ¿Terminaste por hoy? Pulsa BREAK (Caps Shift + "
              "Space) en el Next para salir del dot con elegancia — "
              "una transferencia en curso siempre termina primero.",
        "pt": "A partir daí trocas ficheiros e pastas inteiras nos "
              ...
              "pasta de volta para o PC. Acabou por hoje? Carrega em "
              "BREAK (Caps Shift + Space) no Next para sair do dot "
              "com elegância — uma transferência em curso termina "
              "sempre primeiro.",
        "pl": "Od tej chwili wymieniasz pliki i całe katalogi w OBIE "
              ...
              "na PC. Koniec na dziś? Wciśnij BREAK (Caps Shift + "
              "Space) na Nexcie, by elegancko wyjść z dota — trwający "
        ...
        "ru": "Дальше вы обмениваетесь файлами и целыми каталогами в "
              ...
              "BREAK (Caps Shift + Space) на Next, чтобы изящно выйти "
              "из dot — начатая передача всегда сперва завершится.",
        "cs": "Odtud vyměňuješ soubory i celé složky OBĚMA směry: "
              ...
              "PC. Hotovo pro dnešek? Stiskni BREAK (Caps Shift + "
              "Space) na Nextu a dot se elegantně ukončí — rozběhnutý "
              "přenos se vždy nejdřív dokončí.",
        "fr": "Dès lors, vous échangez fichiers et dossiers entiers "
              ...
              "vers le PC. Fini pour aujourd'hui ? Appuyez sur BREAK "
              "(Caps Shift + Space) sur le Next pour quitter le dot "
              "en douceur — un transfert en cours se termine toujours "
              "d'abord.",
    },
    # ── Buttons / menu ────────────────────────────────────────────────────
    "btn.tour": {
