...
TEXTS = {
    ...
    "ns.setup2": {
        "en": "Next, in ZX Next Unite pick your root synchronization "
              ...
              "(-l or -listen) for the Remote Explorer, or plain '.sync5' for "
              "a Classic sync.",
        "es": "Después, en ZX Next Unite elige tu carpeta raíz de "
              ...
              "quieras: «.sync5 -L» (-l o -listen) para el Remote Explorer, "
        ...
        "pt": "A seguir, no ZX Next Unite escolhe a tua pasta raiz de "
              ...
              "«.sync5 -L» (-l ou -listen) para o Remote Explorer, ou "
        ...
        "pl": "Następnie w ZX Next Unite wybierz główny folder "
              ...
              "odpal wybrany tryb: „.sync5 -L” (-l lub -listen) dla Remote "
        ...
        "ru": "Далее в ZX Next Unite выберите корневую папку "
              ...
              "Next запустите нужный режим: «.sync5 -L» (-l или -listen) для "
        ...
        "cs": "Dál si v ZX Next Unite vyber kořenovou složku "
              ...
              "zvolený režim: „.sync5 -L“ (-l nebo -listen) pro Remote "
        ...
        "fr": "Ensuite, dans ZX Next Unite, choisissez votre dossier "
              ...
              "votre choix : « .sync5 -L » (-l ou -listen) pour le Remote "
    ...
    "ns.options": {
        "en": "Here is the .sync5 spellbook:\n"
              ...
              ".sync5 -L (-l or -listen) — the Remote Explorer file server "
        ...
        "es": "Aquí está el grimorio de .sync5:\n"
              ...
              ".sync5 -L (-l o -listen) — el servidor de archivos del Remote "
        ...
        "pt": "Eis o grimório do .sync5:\n"
              ...
              ".sync5 -L (-l ou -listen) — o servidor de ficheiros do Remote "
        ...
        "pl": "Oto księga zaklęć .sync5:\n"
              ...
              ".sync5 -L (-l lub -listen) — serwer plików Remote Explorera "
        ...
        "ru": "Вот книга заклинаний .sync5:\n"
              ...
              ".sync5 -L (-l или -listen) — файловый сервер Remote Explorer "
        ...
        "cs": "Tady je kniha kouzel .sync5:\n"
              ...
              ".sync5 -L (-l nebo -listen) — souborový server Remote Exploreru "
        ...
        "fr": "Voici le grimoire de .sync5 :\n"
              ...
              "PC\n"
              ".sync5 -L (-l ou -listen) — le serveur de fichiers du Remote "
