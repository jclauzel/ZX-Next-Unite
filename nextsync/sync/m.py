...
methods = {
#	"c" : [ "rel", "\\\\DESKTOP-4BHRSM5\\SDCC\\bin\\sdcc -c -o %DSTFILE %SRCFILE -mz80 --no-std-crt0 --opt-code-speed --Werror --peep-asm --peep-return  --max-allocs-per-node200000" ],
	"c" : [ "rel", "\\\\DESKTOP-4BHRSM5\\SDCC\\bin\\sdcc -c -o %DSTFILE %SRCFILE -mz80 --sdcccall 0 --no-std-crt0 --opt-code-speed --Werror --peep-asm --peep-return" ],
	"s" : [ "rel", "\\\\DESKTOP-4BHRSM5\\SDCC\\bin\\sdasz80 -xlos -g %DSTFILE %SRCFILE" ],
	"ihx" : [ "ihx", "\\\\DESKTOP-4BHRSM5\\SDCC\\bin\\\sdcc -mz80 --sdcccall 0 --no-std-crt0 --opt-code-speed --nostdlib --code-loc 0x2100 -Wl -b_HEADER=0x2000 %REL"],
